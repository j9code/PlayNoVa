...
(function () {
  window.addEventListener('load', function () {
    ...
    var categories = [
      ...
      { name: "Climbing Parks",     key: "climbing",    color: "#e68a00", fa: '<i class="fa-solid fa-person-walking"></i>', filter: function (f) { return sportHas(f, "climbing_adventure") || sportHas(f, "zipline"); } },
